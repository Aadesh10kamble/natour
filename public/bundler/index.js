...
if (loginForm) loginForm.addEventListener("submit", async (event)=>{
    ...
    console.log("1212");
    const alertData = await (0, _loginJs.login)(email, password);
    (0, _alertJs.alertFunction)(...alertData);
});
...
if (changePasswordForm) changePasswordForm.addEventListener("submit", async (event)=>{
    ...
    const alertData = await (0, _loginJs.profilePasswordChange)("password", {
...
if (newPasswordForm) newPasswordForm.addEventListener("submit", async (event)=>{
    event.preventDefault();
    ...
    await (0, _loginJs.newPasswordChange)(data, token);
});
if (bookBtn) bookBtn.addEventListener("click", async (event)=>{
    event.preventDefault();
    const tour = event.target.getAttribute("data");
    console.log("1212");
    await (0, _loginJs.bookTour)(tour);
});

},{"./login.js":"7yHem","./alert.js":"kxdiQ","@babel/polyfill":"dTCHC"}],"7yHem":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "login", ()=>login);
parcelHelpers.export(exports, "logout", ()=>logout);
parcelHelpers.export(exports, "profilePasswordChange", ()=>profilePasswordChange);
parcelHelpers.export(exports, "newPasswordChange", ()=>newPasswordChange);
...
const login = async function(email, password) {
    try {
        ...
        if (response.data.status === "success") // location.assign function will redirect to the given url
...
const newPasswordChange = async function(data, token) {
    try {
        ...
        if (response.data.status === "success") console.log("Password Changed");
    } catch (error) {
        console.log(error);
    }
};
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kxdiQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "alertFunction", ()=>alertFunction);
